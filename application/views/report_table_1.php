                        ...
                        <tr>
                            <td style="min-width: 40px; width: 40px; border-right: 0px">
                                <span style="min-width: 30px; width: 30px;">
                                    <img id="imgListLoading" alt="Loading" src="../../Styles/images/loading1.gif" style="height: 25px; display: none;" />
                    ...
                    <tbody style="background: rgb(255, 255, 255);border-spacing: 0em;" id="tbodyList">
                        <tr class="dataBgHistory" style="height: 25px;" style="">
                            <td class="MemID table_font" >
                                <a href="<?php echo base_url('welcome/report2').'/'.$this->session->userdata('num') ; ?>"> <?php  echo $agents['accnum']; ?></a>
                            </td>
                            ...
                            <td class="right EffectiveAmount blue"  ><a href='<?php echo base_url('welcome/report2').'/'.$this->session->userdata('num') ; ?>'><?php  echo $amount; ?></a>
                            </td>
