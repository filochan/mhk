                    ...
                    <tbody style="background: rgb(255, 255, 255);border-spacing: 0em;" id="tbodyList">
                        <tr class="dataBgHistory" style="height: 25px;" style="">
                            <td class="MemID table_font" >
                                <a href="<?php echo base_url('welcome/searchnow2/').'/'.$this->session->userdata('num') ; ?>"> <?php  echo $agents['accnum']; ?></a>
                            </td>
                            ...
                            <td class="right EffectiveAmount blue"  ><a href='<?php echo base_url('welcome/searchnow2/').'/'.$this->session->userdata('num')  ; ?>'><?php  echo $amount; ?></a>
                            </td>
