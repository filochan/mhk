                    ...
                    <tbody style="background: rgb(255, 255, 255);" id="tbodyList">
                        <tr class="dataBgHistory " style="height: 25px;">
                            <td class="MemID table_font" >
                                <a href="<?php echo base_url('welcome/searchreport3').'/'.$this->session->userdata('num') ; ?>"> <?php  echo $agents['accnum']; ?></a>
                            </td>
                            ...
                            <td class="right EffectiveAmount blue"  ><a href='<?php echo base_url('welcome/searchreport3').'/'.$this->session->userdata('num') ; ?>'><?php  echo $amount; ?></a>
                            </td>
